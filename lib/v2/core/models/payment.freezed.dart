...
class _$PaymentImpl implements _Payment {
  ...
  @override
  String toString() {
    return 'Payment(id: $id, transactionId: $transactionId, transactionType: $transactionType, contactId: $contactId, amount: $amount, method: $method, accountId: $accountId, note: $note, paidOn: $paidOn, createdAt: $createdAt)';
  }
...
abstract class _Payment implements Payment {
  const factory _Payment(
      ...
      final int? accountId,
      final String? note,
      required final DateTime paidOn,
