              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: _searchController.text.isNotEmpty
                        ...
                        : null),
                onChanged: (v) =>
                    sl<ProductBloc>().add(LoadProductsEvent(search: v)),
              )),
          Expanded(child:
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Row(children: [
                        SkuChip(sku: p['sku']?.toString() ?? '', dense: true),
                        const SizedBox(width: 12),
                        if (variationName.isNotEmpty) ...[
                          Flexible(
                            child: Text(variationName,
                                maxLines: 1,
                        ...
                        if (p['category'] != null)
                          Container(
                              ...
                              child: Text((p['category'] as Map)['name'] ?? '',
                                  style: TextStyle(
                        ...
                        if (isLow)
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  color: Colors.red[50],
                                  borderRadius: BorderRadius.circular(4)),
                              child: Text('Stock: $totalStock',
                                  style: TextStyle(
                                      fontSize: 11, color: Colors.red[700]))),
                      ]),
                      trailing: Text(
                          MoneyFormatter.instance
                              .format(p['default_selling_price']),
