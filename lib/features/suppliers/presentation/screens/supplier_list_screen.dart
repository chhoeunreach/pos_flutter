...
class _SupplierListScreenState extends State<SupplierListScreen> {
  ...
  void initState() {
    super.initState();
    sl<ContactBloc>().add(LoadSuppliersEvent());
  }

  @override
  Widget build(BuildContext context) {
    return BlocProvider<ContactBloc>.value(
      value: sl<ContactBloc>(),
      child: Scaffold(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return ListTile(
                    ...
                    title: Text(s['name'] ?? ''),
                    subtitle: Text(
                        '${s['mobile'] ?? '-'} | ${s['supplier_business_name'] ?? ''}'),
                    trailing: due > 0
                        ? Text('Due: ${MoneyFormatter.instance.format(due)}',
